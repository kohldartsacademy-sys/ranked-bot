...
def generate_html():
    ...
    table {margin:auto;margin-top:20px;width:60%;}
    ...
    <button onclick="showTab('world')">🌍 World</button>
    <button onclick="showTab('monthly')">🗓️ Monthly</button>

    <div id="world" class="table active">
    <h2>🌍 World Ranking</h2>
    <table>
    """
